        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="testimonial-thumb1">
              <img src="assets/img/testimonial/19th.png" alt="Fixturbo" />
            </div>
          </div>
          <div className="col-lg-6">
            <div className="space">
              <div className="title-area">
                <span className="sub-title" style={{ color: '#E8092E' }}>Clients testimonial</span>

                <h2 className="sec-title" style={{ color: '#1B1F28' }}>
                  Smart Parking The Best <br /> Solutions
                </h2>
              </div>
                      ...
                      <div className="testi-card">
                        <div className="testi-card_content">
                          ...
                          <p className="testi-card_text">
                            The smart parking system has revolutionized our daily commute. 
                            Finding parking is now effortless with real-time availability updates. 
                            The automated check-in process saves us valuable time every day.
                          </p>
